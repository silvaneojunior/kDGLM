...
# A structure for free-form seaonal trend models
...
# When used in a formula
ffs(period, order = 1, D = 0.98, a1 = 0, R1 = 4, name = "Var.FFS")
```

This function will creates a structural block based on  @WestHarr-DLM, chapter 8, i.e., it creates a latent vector $\theta_t=(\theta_{1,t},...,\theta_{p,t})'$, so that:

$$
\begin{equation}
\begin{aligned}
\theta_{i,t} = \theta_{i+1,t}\\

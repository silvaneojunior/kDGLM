...
```{r echo=TRUE, eval=FALSE}
# eval_past(fitted_data, smooth = TRUE)
# or
coef(fitted_data, smooth = TRUE)
```
...
```{r}
forecast(fitted_data, 20, plot = TRUE)$plot
```
...
plot(fitted_data, smooth = TRUE, plotly = FALSE)
```
...
plot_lat_var(fitted_data, plotly = FALSE, cut_off = 0)$plot +
